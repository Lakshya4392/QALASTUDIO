  ...
  return (
    <div className="pt-40 pb-20 px-10 bg-[#F5F5F7] min-h-screen text-[#1D1D1F] font-sans overflow-hidden">
      <div className="fixed inset-0 pointer-events-none opacity-[0.03] flex items-center justify-center select-none z-0">
        <h1 className="text-[20vw] font-['Oswald'] font-black uppercase tracking-tighter leading-none text-center">
          ART . PASSION
          <br />
          PRECISION
        </h1>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <FadeInSection className="text-center mb-32">
          <h2 className="text-[10px] font-['Oswald'] font-black uppercase tracking-[0.5em] text-[#D4AF37] mb-6">{content.eyebrow}</h2>
          <h1 className="text-6xl md:text-8xl font-['Oswald'] font-black tracking-tighter uppercase leading-none">
        ...
        <div className="flex flex-col gap-32 mb-40">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              <FadeInSection>
                <h3 className="text-[11px] font-['Oswald'] font-black uppercase tracking-[0.5em] text-[#D4AF37]">{member1?.role}</h3>
                <h4 className="text-5xl font-['Oswald'] font-black uppercase tracking-tighter mb-4">{member1?.name}</h4>
                <p className="font-serif italic text-xl leading-relaxed text-[#1D1D1F]/80">"{member1?.quote}"</p>
                <div className="pt-6 border-t border-black/5">
                  <p className="text-[10px] font-['Oswald'] font-bold uppercase tracking-widest text-gray-400">{member1?.footNote}</p>
                </div>
              </FadeInSection>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 lg:order-1 text-right space-y-6">
              <FadeInSection>
                <h3 className="text-[11px] font-['Oswald'] font-black uppercase tracking-[0.5em] text-[#D4AF37]">{member2?.role}</h3>
                <h4 className="text-5xl font-['Oswald'] font-black uppercase tracking-tighter mb-4">{member2?.name}</h4>
                <p className="font-serif italic text-xl leading-relaxed text-[#1D1D1F]/80 ml-auto max-w-lg">"{member2?.quote}"</p>
                <div className="pt-6 border-t border-black/5">
                  <p className="text-[10px] font-['Oswald'] font-bold uppercase tracking-widest text-gray-400">{member2?.footNote}</p>
                </div>
              </FadeInSection>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              <FadeInSection>
                <h3 className="text-[11px] font-['Oswald'] font-black uppercase tracking-[0.5em] text-[#D4AF37]">{member3?.role}</h3>
                <h4 className="text-5xl font-['Oswald'] font-black uppercase tracking-tighter mb-4">{member3?.name}</h4>
                <p className="font-serif italic text-xl leading-relaxed text-[#1D1D1F]/80">"{member3?.quote}"</p>
                <div className="pt-6 border-t border-black/5">
                  <p className="text-[10px] font-['Oswald'] font-bold uppercase tracking-widest text-gray-400">{member3?.footNote}</p>
                </div>
              </FadeInSection>
            </div>
          </div>
        ...
        <section className="mb-40 py-24 text-center border-t border-black/5">
          <FadeInSection>
            <h2 className="text-5xl md:text-7xl font-['Oswald'] font-black tracking-tighter uppercase leading-none mb-12">
              "{content.manifestoHeading} <span className="text-[#D4AF37]">{content.manifestoHighlight}</span> FOR CREATORS."
            </h2>
            <p className="text-[#1D1D1F] font-serif italic text-xl max-w-2xl mx-auto">{content.manifestoText}</p>
          </FadeInSection>
        </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 text-center pb-20">
          <FadeInSection className="group">
            ...
            <h4 className="font-['Oswald'] font-black uppercase tracking-tighter text-lg mb-2">Innovation</h4>
          ...
          <FadeInSection className="group">
            ...
            <h4 className="font-['Oswald'] font-black uppercase tracking-tighter text-lg mb-2">Collaboration</h4>
          ...
          <FadeInSection className="group">
            ...
            <h4 className="font-['Oswald'] font-black uppercase tracking-tighter text-lg mb-2">Excellence</h4>
